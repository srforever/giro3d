    ...
    implements Progress, MemoryUsage, RenderingContextHandler
{
    ...
    readonly colorMap: ColorMap | undefined;
    ...
    private assertInitialized(): this is Required<Layer> {
        return true;
    }
    ...
    constructor(options: LayerOptions) {
        ...
        this._fallbackImagesPromise = undefined;
