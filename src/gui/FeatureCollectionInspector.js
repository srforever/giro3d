...
const FILTER_STATE = {
    ...
    FILTERING: {
        ...
        enter: function(switchState, context, picked) {
            const { instance, features } = context;
        ...
        doButtonAction: function(switchState) {
            switchState(FILTER_STATE.NONE);
        },
    }
}
...
class FeatureCollectionInspector extends EntityInspector {
    ...
    applyFilterState(state, ...args) {
        ...
        state.enter(this.applyFilterState.bind(this), { features: this.features, instance:
            this.instance }, ...args);
    }

    hideAllButClicked() {
        this.filterState.doButtonAction(this.applyFilterState.bind(this), { features: this.features,
