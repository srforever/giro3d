...
class ImageSource extends EventDispatcher {
     ...
     * composition ?
     * @param {boolean} [options.tiled = false] If the generated images follow a tile grid.
    ...
    constructor(options = {}) {
        ...
        /**
         * Gets whether this source generates tiled images, or one image per request.
         */
    ...
    /**
     * Returns the pixel size of this source.
     *
     * In the cases where it is not possible to compute a size, or if the source is not made
     * of pixels (i.e a vector source), then return `null`.
     *
     * @api
     * @returns {{ width: number, height: number }|null} The pixel size of this source.
     */
