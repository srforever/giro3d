...
import type { IUniform, Object3DEventMap } from 'three';
...
class Sky {
    mesh: Mesh<SphereGeometry, ShaderMaterial, Object3DEventMap>;
    uniforms: {
        opacity: IUniform<number>;
        luminance: IUniform<number>;
        turbidity: IUniform<number>;
        reileigh: IUniform<number>;
    ...
    constructor() {
        const skyUniforms = UniformsUtils.clone(skyShader.uniforms);
        ...
        const skyGeo = new SphereGeometry(Ellipsoid.WGS84.semiMajorAxis, 32, 15);
