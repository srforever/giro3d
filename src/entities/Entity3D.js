...
class Entity3D extends Entity {
     ...
     */
    pickObjectsAt(instance, coordinates, options) { // TODO use this._instance, not the parameter
        return Picking.pickObjectsAt(instance, coordinates, this.object3d, options);
    }
