...
class Extent {
     ...
     *
     * @api
     * @param {object} target the object to set with the center's X.
     * If none provided, a new one is created.
     * @param {object} target.x the `x` component
     * @param {object} target.y the `y` component
     * @returns {object} the modified object passed in argument.
     */
    center(target) {
        if (_isTiledCRS(this._crs)) {
     ...
     *
     * @api
     * @param {*} [target] the optional object to set with the width.
     * (in the <code>x</code> property) and height (in the <code>y</code> property)
     * @returns {*} the modified object passed in argument, or a new object if none was provided.
     */
    dimensions(target) {
     ...
     * @param {number} epsilon the precision delta (+/- epsilon)
    ...
    /**
     * Constructs an extents from the specified box.
     *
     * @api
     * @static
     * @param {string} crs the coordinate reference system of the new extents.
     ...
     * @returns {Extent} the constructed extents.
     */
