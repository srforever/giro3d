...
import SmartGrid from '../SmartGrid.js';
...
class ElevationLayer extends Layer {
    ...
    constructor(id, options = {}) {
        super(id, options);
        this.useAsObject = options.useAsObject;
    ...
    update(context, node, parent, initOnly = false) {
        ...
        const texture = node.material.getLayerTexture(this).texture;
        ...
        return context.scheduler.execute(command).then(
            ...
            if (this.elevationFormat === 'cog') {
                ...
                if (!mesh) {
                    ...
                    if (!node.userData.smart) {
                        node.geometry = smartGeometry;
                    } else {
                        node.geometry = mergeBufferGeometries(
                            [node.geometry, smartGeometry],
                        );
                    }
