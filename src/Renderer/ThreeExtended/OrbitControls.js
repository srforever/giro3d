...
class OrbitControls extends EventDispatcher {
    constructor(instance, options = {}) {
        ...
        this.listenToKeyEvents = function listenToKeyEvents(domElement) {
        ...
        const panLeft = (function panLeft() {
            const v = new Vector3();
        ...
        const pan = (function pan() {
            ...
            return function pan(deltaX, deltaY) {
                ...
                if (scope.object.isPerspectiveCamera) {
                    ...
                    // orthographic
                    let distance = deltaX * (scope.object.right - scope.object.left);
                    panLeft(
                        distance / scope.object.zoom / element.clientWidth,
                        scope.object.matrix,
                    );
                    distance = deltaY * (scope.object.top - scope.object.bottom);
                    panUp(
                        distance / scope.object.zoom / element.clientHeight,
                        scope.object.matrix,
                    );
                } else {
