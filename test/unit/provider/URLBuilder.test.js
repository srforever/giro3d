...
describe('URL creations', () => {
    it('should correctly replace ${x}, ${y} and ${z} by 359, 512 and 10', () => {
    ...
    it('should correctly replace %COL, %ROW, %TILEMATRIX by 2072, 1410 and 12', () => {
    ...
    it('should correctly replace %bbox by 12,35,14,46', () => {
    ...
    it('should correctly replace %bbox by 12,14,35,46', () => {
    ...
    it('shouldn\'t use the scientific notation', () => {
